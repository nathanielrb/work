...
*** Index invalidation via deltas                                        :v1:
    CLOCK: [2018-11-16 ven. 17:00]--[2018-11-16 ven. 19:00] =>  2:00
**** TODO Configure lookup table
**** TODO Incorporate multi-types
    
**** TODO Subscribe to deltas                                             
    Subscribe to updates from the Delta service, in order to update
    the indexes
**** TODO Invalidate the index when destructive updates arrive            
**** TODO Automatically recalculate the index                             
...
* Fixes and bugs
** TODO Correct use of application graph                                 :v1:
* Admin
** Architecture
*** v0 planning                                                          :v0:
...
#+CAPTION: Clock summary at [2018-11-16 ven. 17:54]
| Headline                           |    Time |      |
|------------------------------------+---------+------|
| *Total time*                       | *13:54* |      |
|------------------------------------+---------+------|
...
| \emsp Automatic index invalidation |         | 0:54 |
| Admin                              |    1:00 |      |
