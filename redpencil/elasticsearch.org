...
*** TODO Bug: on Common Terms query, not returning data
    only count is correct
*** DONE Correct 'links'                                                 
...
#+CAPTION: Clock summary at [2018-12-18 mar. 19:51]
| Headline                               |    Time |      |
|----------------------------------------+---------+------|
| *Total time*                           | *16:00* |      |
|----------------------------------------+---------+------|
| Features                               |    3:00 |      |
| \emsp JSONAPI-compliant Request Format |         | 3:00 |
