...
*** TODO bug: existing indexes are still getting rebuilt

*** TODO Destroy all indexes on changes
*** TODO Rebuild the necessary indexes
...
#+CAPTION: Clock summary at [2018-12-21 ven. 19:23]
| Headline                               |      Time |      |
|----------------------------------------+-----------+------|
| *Total time*                           | *1d 0:00* |      |
|----------------------------------------+-----------+------|
...
| \emsp Monitor configuration            |           | 2:00 |
