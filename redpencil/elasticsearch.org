...
*** Semaphores to handle near-simultaneous requests and updates :v1:
...
** Eager indexing                                                        :v1:
   CLOCK: [2018-11-27 mar. 17:45]--[2018-11-27 mar. 19:00] =>  1:15
...
* Code, Testing and Bugs
** Code Organization
*** TODO Use RequestStore instead of Settings for request-specific globals :v1:
** Tests
*** Test setup with rewriter                                        :v1:in_progress:
    CLOCK: [2018-11-28 mer. 15:30]--[2018-11-28 mer. 19:30] =>  4:00
**** DONE write plugin
**** TODO modify rewriter to format queried annotations
...
#+CAPTION: Clock summary at [2018-11-28 mer. 19:23]
| Headline                           | Time       |      |
|------------------------------------+------------+------|
| *Total time*                       | *1d 14:00* |      |
|------------------------------------+------------+------|
