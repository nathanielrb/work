...
*** TODO Why are queries logged on /index call, but not on initial indexing?
*** TODO Feature turn off raw ES dsl endpoint
*** TODO re-test loading without docs... maybe it works?
...
#+CAPTION: Clock summary at [2019-08-17 sam. 22:54]
| Headline                              | Time      |       |
|---------------------------------------+-----------+-------|
| *Total time*                          | *1d 5:00* |       |
|---------------------------------------+-----------+-------|
| Bugs                                  | 1d 5:00   |       |
| \emsp TODO Filter gt problem          |           | 10:00 |
| \emsp TODO Duplicate results          |           |  8:00 |
| \emsp Code organization and bug fixes |           | 11:00 |
#+END:
